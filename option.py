...
# Data specifications
parser.add_argument('--dir_data', type=str, default='D:/NON',
...
parser.add_argument('--data_range', type=str, default='800-900',#
...
parser.add_argument('--chunk_size',type=int,default=144,#132
...
parser.add_argument('--model', default='SSFormer',
                    help='model name')
...
parser.add_argument('--test_every', type=int, default=500,#1000  500
...
# Log specifications
parser.add_argument('--save', type=str, default='NLSN_x2',
...
parser.add_argument('--save1', action='store_true',
                    help='save output results')
